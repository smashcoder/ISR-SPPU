    ...
    private static void remove_punctutaion(File fi)
    {
        try {
            ...
            while(sc_punctuation.hasNext())
            {
                ...
                if (!str_r.toLowerCase().equals("the") && !str_r.toLowerCase().equals("is") && !str_r.toLowerCase().equals("and") && !str_r.toLowerCase().equals("of") && !str_r.toLowerCase().equals("are") && !str_r.toLowerCase().equals("for") && !str_r.toLowerCase().equals("in") && !str_r.toLowerCase().equals("my")&& !str_r.toLowerCase().equals("i")&& !str_r.toLowerCase().equals("am") && !str_r.toLowerCase().equals("a"))
                {
                    out.write(str_r+" ");
                }    
            }
